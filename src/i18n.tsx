...
const ID: Dict = {
  ...
  'prom.form.desainHint': 'JPG/PNG — otomatis diperkecil untuk posting. Karyawan bisa mengunduhnya saat promo tayang.',
  // Settings - language
...
const EN: Dict = {
  ...
  'prom.form.desainHint': 'JPG/PNG — auto-resized for posting. Staff can download it once the promo is live.',
  // Settings - language
