...
const ID: Dict = {
  ...
  'page.promosi.title': 'Papan Promosi',
  'page.promosi.sub': 'Kumpulkan ide & kelola program promosi marketing',
  // ===== Papan Promosi =====
  'nav.promosi': 'Promosi',
  'side.promosi': 'Papan Promosi',
  'prom.tahap.ide': 'Ide',
  'prom.tahap.rencana': 'Direncanakan',
  'prom.tahap.comingsoon': 'Coming Soon',
  'prom.tahap.berjalan': 'Berjalan',
  'prom.tahap.selesai': 'Selesai',
  'prom.count': 'program',
  'prom.tambah': 'Tambah Promosi',
  'prom.usulkan': 'Usulkan Ide',
  'prom.edit': 'Edit Promosi',
  'prom.hapus': 'Hapus',
  'prom.setujui': 'Setujui',
  'prom.editSetujui': 'Edit lalu setujui',
  'prom.menunggu': 'Menunggu ACC',
  'prom.badge.ideAnda': 'Ide Anda',
  'prom.tugasAnda': 'Tugas Anda',
  'prom.tugasAnda.nota': 'Kartu yang Anda pegang sebagai PIC. Centang tahap produksinya begitu selesai dikerjakan.',
  'prom.ideAnda.nota': 'Ide yang Anda usulkan beserta perjalanannya — dari menunggu ACC sampai kartunya ditutup.',
  'prom.jejak.lbl': 'Perjalanan ide ini',
  'prom.jejak.nota': 'Tahap digerakkan pengelola. Anda hanya bisa mengubah kartunya selama masih menunggu ACC.',
  'prom.pindahTahap': 'Pindah tahap',
  'prom.empty.admin': 'Belum ada program promosi. Klik "Tambah Promosi" untuk mulai.',
  'prom.empty.karyawan': 'Belum ada promo yang berjalan. Punya ide? Klik "Usulkan Ide".',
  'prom.empty.menunggu': 'Tidak ada ide menunggu persetujuan.',
  'prom.inbox.title': 'Ide Menunggu Persetujuan',
  'prom.form.judul': 'Judul promosi',
  'prom.form.judulPh': 'mis. Promo Wisuda, Bundling Couple',
  'prom.form.deskripsi': 'Deskripsi / detail ide',
  'prom.form.deskripsiPh': 'Tuliskan ide, target, mekanisme promo…',
  'prom.form.tahap': 'Tahap',
  'prom.form.status': 'Status persetujuan',
  'prom.form.mulai': 'Mulai',
  'prom.form.selesai': 'Selesai',
  'prom.form.simpan': 'Simpan',
  'prom.form.batal': 'Batal',
  'prom.form.judulWajib': 'Judul promosi wajib diisi',
  'prom.toast.simpan': 'Promosi "{judul}" disimpan',
  'prom.toast.usul': 'Ide "{judul}" terkirim, menunggu persetujuan admin',
  'prom.toast.hapus': 'Promosi dihapus',
  'prom.toast.setuju': 'Promosi "{judul}" disetujui',
  'prom.hapus.konfirmasi': 'Hapus promosi "{judul}"?',
  'prom.oleh': 'oleh',
  'prom.ideDari': 'Ide dari',
  'prom.adaDesain': 'Ada desain',
  'prom.tanpaDeskripsi': 'Tanpa deskripsi.',
  'prom.unduh': 'Unduh Desain',
  'prom.form.desain': 'Desain sosial media (untuk diposting)',
  'prom.lampirkan': 'Lampirkan desain',
  'prom.desainAntre': '{n} desain menunggu ACC',
  'prom.lampir.nota':
    'Desain yang kamu lampirkan baru tayang setelah disetujui owner atau manajer.',
  'prom.lampir.kirim': 'Kirim untuk disetujui',
  'prom.acc.title': 'Desain menunggu persetujuan',
  'prom.acc.setujui': 'Setujui',
  'prom.acc.tolak': 'Tolak',
  'prom.acc.menunggu': 'Menunggu ACC',
  'prom.acc.tanpaNama': 'pengunggah tidak tercatat',
  'prom.toast.lampirAdmin': 'Desain ditambahkan ke kartu.',
  'prom.toast.lampirUsul': 'Desain terkirim — menunggu persetujuan owner/manajer.',
  'prom.form.desainUnggah': 'Unggah desain',
  'prom.form.desainTambah': 'Tambah desain lagi',
  'prom.form.desainGanti': 'Ganti desain',
  'prom.form.desainHapus': 'Hapus desain',
  'prom.form.desainHint': 'JPG/PNG, bisa pilih beberapa sekaligus (maks {maks}) — otomatis diperkecil untuk posting. Karyawan bisa mengunduhnya setelah desainnya disetujui.',
  'prom.form.desainPenuh': 'Maksimal {maks} gambar per kartu. Untuk file mentah atau folder berisi banyak varian, pakai tautan di bawah.',
  'prom.form.tautan': 'Tautan desain (Google Drive, Canva, dll)',
  'prom.form.tautanPh': 'Tempel tautan, lalu Tambah',
  'prom.form.tautanTambah': 'Tambah',
  'prom.form.tautanHapus': 'Hapus tautan',
  'prom.form.tautanHint': 'Untuk file besar atau folder berisi banyak varian. Pastikan aksesnya dibuka untuk yang butuh — app tidak bisa memeriksanya.',
  'prom.form.tautanInvalid': 'Tautan tidak terbaca — contoh: drive.google.com/...',
  // Settings - language
  ...
  'inc.rekap.hint':
    'Angka di atas khusus bulan ini: Tunai + QRIS dari metode pembayaran tiap laporan, gaji dari slip semua karyawan, lain-lain dari halaman Pengeluaran.',
  'inc.kas.title': 'Buku kas — dompet & rekening',
  'inc.kas.sd': ' · {bulan}',
  'inc.kas.dompet': 'Dompet (tunai)',
  'inc.kas.rekening': 'Rekening (QRIS & transfer)',
  'inc.kas.kolTgl': 'Tgl',
  'inc.kas.kolKet': 'Keterangan',
  'inc.kas.kolNilai': 'Masuk / keluar',
  'inc.kas.kolSaldo': 'Saldo',
  'inc.kas.masuk': 'Saldo dibawa dari bulan sebelumnya',
  'inc.kas.kosong': 'Belum ada mutasi di bulan ini.',
  'inc.kas.seharusnya': 'Seharusnya ada sekarang',
  'inc.kas.aktual': 'Uang yang benar-benar ada',
  'inc.kas.belumDicek': 'Belum dicek — isi jumlah sebenarnya di atas.',
  'inc.kas.cocok': '✓ Cocok dengan catatan',
  'inc.kas.lebih': 'Lebih {rp} dari catatan — ada pemasukan yang belum dicatat.',
  'inc.kas.kurang': 'Kurang {rp} dari catatan — ada pengeluaran yang belum dicatat.',
  'inc.kas.barisIncome': 'Penjualan',
  'inc.kas.barisSetoranKeluar': 'Setor ke rekening',
  'inc.kas.barisSetoranMasuk': 'Setoran dari tunai',
  'inc.kas.barisPengeluaran': 'Pengeluaran',
  'inc.kas.barisGaji': 'Gaji dibayar',
  'inc.kas.hint':
    'Tiap baris adalah satu pergerakan uang: penjualan dari laporan harian, setoran, pengeluaran (sesuai sumber dananya), dan gaji yang sudah ditandai dibayar. Kalau saldo tidak cocok, telusuri barisnya di sini — jangan menebak. Gaji ditaruh di tanggal terakhir bulannya karena slip hanya menyimpan periode, bukan tanggal transfer.',
  'inc.awal.title': 'Saldo Awal (saat sistem mulai)',
  'inc.awal.dompet': 'Saldo awal dompet',
  'inc.awal.rekening': 'Saldo awal rekening',
  'inc.awal.hint':
    'Kas/uang yang sudah ada sebelum sistem dibangun (mis. saldo rekening dari penjualan sebelumnya). Diisi sekali; jadi titik awal perhitungan kumulatif.',
  'inc.setor.tombol': 'Setoran ke rekening',
  'inc.setor.totalSd': 'Total setoran s/d bulan ini',
  'inc.setor.title': 'Setoran Tunai ke Rekening',
  'inc.setor.sub': 'Catat uang tunai yang disetor ke bank · {bulan}',
  'inc.setor.jumlah': 'Jumlah disetor',
  'inc.setor.catatanPh': 'mis. setor tunai ke BCA',
  'inc.setor.hint':
    'Uang tunai yang disetor pindah dari dompet ke rekening: saldo dompet yang diharapkan berkurang, saldo rekening bertambah sebesar setoran. Tidak mengubah nilai Income Tunai/QRIS.',
  'inc.setor.catat': 'Catat setoran',
  'inc.setor.riwayat': 'Riwayat setoran bulan ini',
  'inc.setor.hapus': 'Hapus setoran',
  'inc.setor.toastTambah': 'Setoran {rp} dicatat',
  'inc.setor.toastHapus': 'Setoran dihapus',
...
const EN: Dict = {
  ...
  'page.promosi.title': 'Promo Board',
  'page.promosi.sub': 'Collect ideas & manage marketing promo programs',
  // ===== Promo Board =====
  'nav.promosi': 'Promos',
  'side.promosi': 'Promo Board',
  'prom.tahap.ide': 'Idea',
  'prom.tahap.rencana': 'Planned',
  'prom.tahap.comingsoon': 'Coming Soon',
  'prom.tahap.berjalan': 'Running',
  'prom.tahap.selesai': 'Done',
  'prom.count': 'programs',
  'prom.tambah': 'Add Promo',
  'prom.usulkan': 'Suggest Idea',
  'prom.edit': 'Edit Promo',
  'prom.hapus': 'Delete',
  'prom.setujui': 'Approve',
  'prom.editSetujui': 'Edit then approve',
  'prom.menunggu': 'Awaiting approval',
  'prom.badge.ideAnda': 'Your idea',
  'prom.tugasAnda': 'Your tasks',
  'prom.tugasAnda.nota': 'Cards you own as PIC. Tick each production stage as you finish it.',
  'prom.ideAnda.nota': 'The ideas you suggested and how far they have got — from awaiting approval to the card being closed.',
  'prom.jejak.lbl': 'This idea so far',
  'prom.jejak.nota': 'Stages are moved by a manager. You can only edit the card while it is awaiting approval.',
  'prom.pindahTahap': 'Move stage',
  'prom.empty.admin': 'No promo programs yet. Click "Add Promo" to start.',
  'prom.empty.karyawan': 'No running promos yet. Got an idea? Click "Suggest Idea".',
  'prom.empty.menunggu': 'No ideas awaiting approval.',
  'prom.inbox.title': 'Ideas Awaiting Approval',
  'prom.form.judul': 'Promo title',
  'prom.form.judulPh': 'e.g. Graduation Promo, Couple Bundle',
  'prom.form.deskripsi': 'Description / idea details',
  'prom.form.deskripsiPh': 'Write the idea, target, promo mechanics…',
  'prom.form.tahap': 'Stage',
  'prom.form.status': 'Approval status',
  'prom.form.mulai': 'Start',
  'prom.form.selesai': 'End',
  'prom.form.simpan': 'Save',
  'prom.form.batal': 'Cancel',
  'prom.form.judulWajib': 'Promo title is required',
  'prom.toast.simpan': 'Promo "{judul}" saved',
  'prom.toast.usul': 'Idea "{judul}" submitted, awaiting admin approval',
  'prom.toast.hapus': 'Promo deleted',
  'prom.toast.setuju': 'Promo "{judul}" approved',
  'prom.hapus.konfirmasi': 'Delete promo "{judul}"?',
  'prom.oleh': 'by',
  'prom.ideDari': 'Idea from',
  'prom.adaDesain': 'Has design',
  'prom.tanpaDeskripsi': 'No description.',
  'prom.unduh': 'Download Design',
  'prom.form.desain': 'Social media design (to post)',
  'prom.lampirkan': 'Attach design',
  'prom.desainAntre': '{n} design(s) awaiting approval',
  'prom.lampir.nota':
    'Designs you attach go live only after the owner or manager approves them.',
  'prom.lampir.kirim': 'Send for approval',
  'prom.acc.title': 'Designs awaiting approval',
  'prom.acc.setujui': 'Approve',
  'prom.acc.tolak': 'Reject',
  'prom.acc.menunggu': 'Awaiting approval',
  'prom.acc.tanpaNama': 'uploader not recorded',
  'prom.toast.lampirAdmin': 'Design added to the card.',
  'prom.toast.lampirUsul': 'Design sent — awaiting owner/manager approval.',
  'prom.form.desainUnggah': 'Upload design',
  'prom.form.desainTambah': 'Add another design',
  'prom.form.desainGanti': 'Replace design',
  'prom.form.desainHapus': 'Remove design',
  'prom.form.desainHint': 'JPG/PNG, pick several at once (max {maks}) — auto-resized for posting. Staff can download them once the design is approved.',
  'prom.form.desainPenuh': 'Max {maks} images per card. For raw files or folders with many variants, use a link below.',
  'prom.form.tautan': 'Design links (Google Drive, Canva, etc.)',
  'prom.form.tautanPh': 'Paste a link, then Add',
  'prom.form.tautanTambah': 'Add',
  'prom.form.tautanHapus': 'Remove link',
  'prom.form.tautanHint': 'For large files or folders with many variants. Make sure access is open to whoever needs it — the app cannot check that.',
  'prom.form.tautanInvalid': 'Link not recognised — e.g. drive.google.com/...',
  // Settings - language
  ...
  'inc.rekap.hint':
    'The figures above cover this month only: Cash + QRIS from each report’s payment method, salary from all employees’ slips, other expenses from the Expenses page.',
  'inc.kas.title': 'Cash book — wallet & account',
  'inc.kas.sd': ' · {bulan}',
  'inc.kas.dompet': 'Wallet (cash)',
  'inc.kas.rekening': 'Account (QRIS & transfers)',
  'inc.kas.kolTgl': 'Date',
  'inc.kas.kolKet': 'Description',
  'inc.kas.kolNilai': 'In / out',
  'inc.kas.kolSaldo': 'Balance',
  'inc.kas.masuk': 'Balance carried from previous month',
  'inc.kas.kosong': 'No movements this month yet.',
  'inc.kas.seharusnya': 'Expected right now',
  'inc.kas.aktual': 'Money actually there',
  'inc.kas.belumDicek': 'Not checked yet — enter the actual amount above.',
  'inc.kas.cocok': '✓ Matches the records',
  'inc.kas.lebih': '{rp} more than recorded — some income is missing.',
  'inc.kas.kurang': '{rp} less than recorded — some expense is missing.',
  'inc.kas.barisIncome': 'Sales',
  'inc.kas.barisSetoranKeluar': 'Deposit to account',
  'inc.kas.barisSetoranMasuk': 'Deposit from cash',
  'inc.kas.barisPengeluaran': 'Expense',
  'inc.kas.barisGaji': 'Salary paid',
  'inc.kas.hint':
    'Each row is one movement of money: sales from daily reports, deposits, expenses (by fund source), and salaries already marked as paid. When a balance does not match, trace the row here instead of guessing. Salaries sit on the last day of their month because a slip stores only the period, not the transfer date.',
  'inc.awal.title': 'Opening Balance (when tracking started)',
  'inc.awal.dompet': 'Opening wallet balance',
  'inc.awal.rekening': 'Opening account balance',
  'inc.awal.hint':
    'Cash/money already present before the system was built (e.g. account balance from earlier sales). Set once; it becomes the starting point for the cumulative reconciliation.',
  'inc.setor.tombol': 'Deposit to account',
  'inc.setor.totalSd': 'Total deposits through this month',
  'inc.setor.title': 'Cash Deposit to Account',
  'inc.setor.sub': 'Record cash deposited to the bank · {bulan}',
  'inc.setor.jumlah': 'Amount deposited',
  'inc.setor.catatanPh': 'e.g. cash deposit to BCA',
  'inc.setor.hint':
    'Deposited cash moves from the wallet to the account: expected wallet balance drops and account balance rises by the deposit. Does not change Cash/QRIS income.',
  'inc.setor.catat': 'Record deposit',
  'inc.setor.riwayat': 'Deposits this month',
  'inc.setor.hapus': 'Delete deposit',
  'inc.setor.toastTambah': 'Deposit {rp} recorded',
  'inc.setor.toastHapus': 'Deposit deleted',
  // Big / small cash bar
